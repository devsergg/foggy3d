  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'colored': '0 4px 25px -5px rgba(249, 115, 22, 0.2), 0 10px 10px -5px rgba(249, 115, 22, 0.04)',
        'colored-lg': '0 10px 40px -10px rgba(249, 115, 22, 0.3), 0 2px 10px -2px rgba(249, 115, 22, 0.1)',
